      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-gray-800 mb-4">lunara</h3>
            <p className="text-gray-600 mb-4 max-w-md">
              Tu tienda online de confianza para todo lo que tu mascota necesita. 
              Productos de calidad, envío rápido y atención personalizada.
            </p>
          ...
          {/* Atención al cliente */}
          <div>
            <h4 className="text-lg font-semibold text-gray-800 mb-4">Atención al cliente</h4>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Contáctanos
        ...
        <div className="border-t border-gray-300 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-600 text-sm mb-4 md:mb-0">
              © 2024 lunara. Todos los derechos reservados.
            </div>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div className="flex items-center justify-center space-x-2">
              ...
              <span className="text-sm text-gray-600">Envío gratis desde $50</span>
            </div>
            <div className="flex items-center justify-center space-x-2">
