    ...
    <div style={{ backgroundColor: 'rgb(var(--theme-neutral-light))' }}>
      ...
      <section id="productos-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style={{ padding: 'var(--theme-section-padding) 1rem' }}>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 btn-boutique-secondary text-sm"
              >
                <Icons.Sort />
                <span>Ordenar</span>
        ...
        {productosAMostrar.length === 0 ? (
          ...
          <div className="grid-boutique grid-boutique-products">
            {productosAMostrar.map((producto, index) => (
              ...
              >
                {/* Product Image */}
                <div className="relative aspect-square overflow-hidden rounded-sm mb-6" style={{ backgroundColor: 'rgb(var(--theme-secondary))' }}>
                ...
                <div className="space-y-4">
                  <h3 
                    className="text-lg font-medium group-hover:color-accent transition-colors duration-300 text-serif"
                    style={{ color: 'rgb(var(--theme-neutral-dark))' }}
                  >
                    {producto.name}
                  </h3>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button 
                      ...
                      className={`text-sm px-4 py-2 rounded-sm transition-all duration-300 text-sans ${
