...
const STORE_TEXTS: Record<StoreLanguage, StoreTexts> = {
  ...
  pt: {
    ...
    // Filtros dinâmicos - Roupas e geral
    filterColor: 'Cor',
    filterSize: 'Tamanho',
    filterGender: 'Gênero',
    ...
    filterStyle: 'Estilo',
    filterCategoryType: 'Tipo',
    filterCare: 'Cuidado',
    filterFit: 'Ajuste',
    filterNeckline: 'Decote',
    filterSleeveType: 'Manga',
    filterPattern: 'Padrão',
    filterBrand: 'Marca',
    filterAgeGroup: 'Grupo de idade',
    
    // Filtros dinâmicos - Animais de estimação
    filterPetSpecialDiet: 'Dieta especial',
    filterPetFoodType: 'Tipo de alimento',
    filterPetProteinSource: 'Fonte de proteína',
    filterPetAge: 'Idade do animal',
    filterPetSize: 'Tamanho do animal',
    filterPetBreed: 'Raça',
    filterPetLifeStage: 'Estágio de vida',
    filterPetHealthCondition: 'Condição de saúde',
    filterPetActivityLevel: 'Nível de atividade',
    filterPetFlavor: 'Sabor',
    filterPetTexture: 'Textura',
    filterPetIngredient: 'Ingrediente',
    // Botões e ações
