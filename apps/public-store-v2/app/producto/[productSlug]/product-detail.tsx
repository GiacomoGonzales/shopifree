...
import { getStoreIdBySubdomain, getStorePrimaryLocale, getStoreCheckoutConfig, StoreAdvancedConfig } from '../../../lib/store';
...
export default function ProductDetail({ storeSubdomain, productSlug }: Props) {
  ...
  try {
    promotionsDataFromHook = usePromotions(storeId || null, product?.id || '', originalPrice);
