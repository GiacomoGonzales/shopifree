  ...
  return (
    ...
    >
      ...
      <div className="flex items-center">
        ...
        >
          <div className={`w-11 h-6 ${section.enabled ? 'bg-gray-600' : 'bg-gray-200'} rounded-full relative transition-colors duration-200`}>
              ...
              <div className="mb-8">
                ...
                <div className="mb-4 p-3 bg-gray-50 border border-gray-200 rounded-lg">
                  <p className="text-sm text-gray-700">
                    ...
                    {t('sections.dragToReorderSections')}
                  </p>
                </div>
              ...
              <div className="border-t pt-6">
                <div className="flex justify-end">
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-600 disabled:opacity-50"
                  >
                    {saving ? (
