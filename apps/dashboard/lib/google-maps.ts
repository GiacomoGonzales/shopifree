// Módulo centralizado para gestionar Google Maps API
declare global {
  interface Window {
...
class GoogleMapsLoader {
  ...
  load(): Promise<void> {
    ...
    this.loadPromise = new Promise((resolve, reject) => {
      ...
      script.src = `https://maps.googleapis.com/maps/api/js?key=${apiKey}&libraries=places,drawing&language=es&callback=${callbackName}`;
      script.async = true;
      script.defer = true;
      script.onerror = () => {
